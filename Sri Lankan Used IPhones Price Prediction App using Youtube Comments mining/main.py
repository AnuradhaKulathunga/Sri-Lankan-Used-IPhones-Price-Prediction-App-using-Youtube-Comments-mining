...
phone_dict_path = "Dictionaries_TextBlob/Sort_Encodes_Phones_dict.json"
full_data_path = "Full_Data_FbProphet_Sentiments_v2.xlsx"
cleaned_phone_options_path = "Phone_Default_Details/Cleaned_phone_options_df.xlsx"
scaler_path = 'Price_Predict_XGBBOOST/scaler_X.pkl'
model_path = 'Price_Predict_XGBBOOST/best_xgb_params.pkl'
onehot_path = 'Price_Predict_XGBBOOST/onehotencoder.pkl'
phone_storages_path = 'Phone_Default_Details/F_Phone_storages.xlsx'
phone_colours_path = 'Phone_Default_Details/F_Phone_colours.xlsx'
